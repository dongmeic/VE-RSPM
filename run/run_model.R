...
for(Year in getYears()) {
  ...
  runModule("CalculateCarbonIntensity",        "VEPowertrainsAndFuelsxSTSRec", RunFor = "AllYears",    RunYear = Year)
  runModule("AssignHhVehiclePowertrain",       "VEPowertrainsAndFuelsxSTSRec", RunFor = "AllYears",    RunYear = Year)
  for (i in 1:2) {
...
#Produce output summaries
#------------------------

source("VERSPM_MeasuresOutputScript.r")
